...
const questions = [
  ...
  },
  {
    id: 15,
    module: '交付服务',
    text: '在服务交付中，除了你个人的核心专业交付外，其他服务流程（如信息收集、进度跟进、资料整理等）是否已经系统化？',
    options: [
      { value: 1, label: '包含基础流程在内的所有环节都完全依赖我本人，客户一多就手忙脚乱' },
      { value: 2, label: '核心交付靠我，但日常的基础服务流程也经常需要我亲自跟进和处理' },
      { value: 3, label: '核心交付靠我，基础流程有一些框架，但执行起来不够顺畅' },
      { value: 4, label: '核心交付靠我，但大部分前置准备和后置服务已经有相对标准的操作' },
      { value: 5, label: '核心交付依然发挥我的不可替代性，但前后的服务和运营流程已完全标准化、系统化' }
    ]
  },
  {
    id: 16,
